...
**Status:** in progress (02-00 through 02-06 done, pending review).
...
| 07 | `partysocket` client wrapper: ticket in `query`, typed event emit, terminal-error detection | next |
