...
| # | Story | Status |
|---|---|---|
| [00](./00-message-protocol.md) | Message protocol: zod schemas + `parseClientMessage` / `serializeServerMessage` + `assertNever`; shared-package unit tests | done, in review |
...
| [03](./03-room-code-generation.md) | Shared room-code generation module from epic 00 + tests | done, in review |
