...
export const GAME_MODES: Record<GameMode, GameModeInfo> = {
  sync: {
    ...
    tries: 5,
    description:
      '5 tries. Everyone submits a guess before the round timer expires, then all guesses reveal together. Multiple correct guesses at once, or no correct guess after the fifth round, trigger a bboy dance-off to decide the winner.',
  },
  realtime: {
    id: 'realtime',
    label: 'Real-time',
